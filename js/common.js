...
m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
	...
	ga("create", "UA-82257872-2", "auto", {name: "Local"})
	ga("create", "UA-83365231-1", "auto", {name: "International"})
	ga('Local.require', 'displayfeatures');
	ga('International.require', 'displayfeatures');
	ga('Local.send', 'pageview');
	ga('International.send', 'pageview');

$(function(){
	$('a').click(function(e){
		ga('Local.send','event','clubt-fal', $(location).attr('href'), $(this).attr('href'));
	});
});
